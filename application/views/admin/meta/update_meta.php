<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">Whatsapp Api <span class="text-danger">*</span>
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="whatsapp_api" value="<?php echo $meta->whatsapp_api; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">AP username <span class="text-danger">*</span>
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="ap_username" value="<?php echo $meta->ap_username; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">AP Password <span class="text-danger">*</span>
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="ap_password" value="<?php echo $meta->ap_password; ?>">
            </div>
        </div>

        <div class="form-group row">
            <label class="col-lg-3 col-form-label">Tax <span class="text-danger">*</span>
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="tax" value="<?php echo $meta->tax; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">Api Url Login AP2 <span class="text-danger">*</span>
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="api_login" value="<?php echo $meta->api_login; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">Api Url Transaction AP2 <span class="text-danger">*</span>
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="api_transaction" value="<?php echo $meta->api_transaction; ?>">
            </div>
        </div>
